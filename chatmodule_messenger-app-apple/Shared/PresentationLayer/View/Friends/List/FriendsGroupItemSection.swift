...
/// Usage:
///
///       FriendsGroupItemSection(model: FriendInfo(...),
///                               isChecked: false,
///                               onCheckChanged: { ... })
///
public struct FriendsGroupItemSection: View {
    ...
    /// Create FriendsGroupItemSection
    ///
    /// - Parameters:
...
#if DEBUG
struct FriendsGroupItemSection_Previews: PreviewProvider {
    static let model = FriendInfo(account: .init(signInId: "0", username: "ChatModule"))

    static var previews: some View {
        VStack {
            FriendsGroupItemSection(model: model)
        }
