//
//  FavoritesFriendsGroupItemSection.swift
...
/// Favorites Friends Group Item Section
///
...
/// Usage:
///
///      FavoritesFriendsGroupItemSection(model: FriendInfo(...),
///                                       isChecked: false,
///                                       onCheckChanged: { ... })
///
public struct FavoritesFriendsGroupItemSection: View {
    ...
    /// Create FavoritesFriendsGroupItemSection
    ///
    /// - Parameters:
...
#if DEBUG
struct FavoritesFriendsGroupItemSection_Previews: PreviewProvider {
    static let model = FriendInfo(account: .init(signInId: "0", username: "ChatModule"))

    static var previews: some View {
        VStack {
            FavoritesFriendsGroupItemSection(model: model)
        }
