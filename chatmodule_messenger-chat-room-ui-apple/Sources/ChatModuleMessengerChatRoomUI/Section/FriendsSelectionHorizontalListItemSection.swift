//
//  FriendsSelectionHorizontalListItemSection.swift
...
/// Friends Selection Horizontal ListItem Section
///
public struct FriendsSelectionHorizontalListItemSection: View {
    ...
    private let bottomImage: UIImage = UIImage(systemName: "star.fill")!
    ////////
...
struct FriendsSelectionHorizontalListItemSection_Previews: PreviewProvider {
    static var previews: some View {
        FriendsSelectionHorizontalListItemSection()
    }
}
