//
//  ChatRoomCheckableFriendItemSection.swift
...
/// Chat Room Checkable Friend Item
///
...
/// Usage:
///
///      ChatRoomCheckableFriendItemSection(model: AccountInfo(signInId: "",
///                                                            username: "Name 01"),
///                                         isChecked: false,
///                                         onCheckChanged: { ... })
///
public struct ChatRoomCheckableFriendItemSection: View {
    ...
    /// Create ChatRoomCheckableFriendItemSection with ``AccountInfo``
    ///
    /// - Parameters:
...
#if DEBUG
struct ChatRoomCheckableFriendItemSection_Previews: PreviewProvider {
