//
//  UnifiedSearchResultChatRoomItemSection.swift
...
//ChatRoomInfoItemSection와 동일
public struct UnifiedSearchResultChatRoomItemSection: View {
    ...
    public var body: some View {
        ChatTwoLineComponent(checkBox: checkBox,
                             ...
                             amountPerson: roomInfo.memberCount, favorite: roomFavorite,
...
#if DEBUG
struct UnifiedSearchResultChatRoomItemSection_Previews: PreviewProvider {
    static var previews: some View {
        UnifiedSearchResultChatRoomItemSection(roomInfo: RoomInfo(roomId: 0,
